    ...
    .forEach((field) => {
      ...
      field.addEventListener('input', () => {
        ...
        if (
          ...
          field.nextElementSibling.classList.contains('text-red-600')
        ) {
  ...
  form.addEventListener('submit', (e) => {
    ...
    if (form.id === 'appointment-form') {
      ...
      setTimeout(() => {
        ...
        announce(
          'appointment-message',
          'Thank you for scheduling your appointment! We will send a confirmation email shortly.',
        );
        form.reset();
...
document.querySelectorAll('a[href^="#"]').forEach((anchor) => {
  anchor.addEventListener('click', function (e) {
    ...
    if (target) {
      ...
      const headerHeight =
        document.querySelector('nav').offsetHeight + 20 || 20;
