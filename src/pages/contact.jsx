        ...
        >
          <div className="mx-auto w-full max-w-4xl px-4 sm:px-6 lg:px-8">
            ...
            <p className="mt-4 text-left text-sm text-gray-500 leading-relaxed">
              <strong>Disclaimer:</strong> Keystone Notary Group, LLC is not a
              law firm and does not provide legal advice, guidance on document
              selection, or assistance in preparing legal documents. For
              questions about what type of document you need, please consult a
              licensed attorney.
            </p>
            {/* Additional instructions and contact information */}
            <p className="mt-8 text-sm text-gray-400 sm:mt-10 leading-relaxed">
              Please mention the type of document or notarization service you
              are requesting.
            </p>
        ...
        >
          <div className="mx-auto w-full max-w-4xl px-4 sm:px-6 lg:px-8">
            <div className="bg-neutral-900 p-6 ring-1 ring-neutral-700 shadow-[0_0_20px_rgba(255,255,255,0.05)]">
              ...
              <ul className="list-disc list-inside space-y-1 text-gray-300 border-l-4 border-blue-600 pl-4">
