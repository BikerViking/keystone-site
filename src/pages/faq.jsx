        ...
        >
          <div className="mx-auto w-full max-w-screen-lg px-4 sm:px-6 lg:px-8">
            ...
            <div className="mt-12 border border-blue-500/30 bg-neutral-800 p-6 text-center shadow-inner">
              <h2 className="text-center text-3xl font-semibold tracking-wide text-white mb-8">
                Still have questions?
              </h2>
              <div
                aria-hidden="true"
                className="mb-6 h-0.5 w-24 bg-gradient-to-r from-blue-500/50 to-blue-500/0"
              />
              <motion.a
